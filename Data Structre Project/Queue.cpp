...
public:
	...
	void Enqueue()
	{
		...
		cout << "\nSuccessfully Inserted/Enqueued into Queue..!\n\n";
	}
	...
	void Display()
	{
		...
		{
			temp = front;
			cout << "\t\tPassenger Record from front to rear " << endl;
			while (temp != NULL)
			{
				temp->display();
				temp = temp->next;
	...
	void Dequeue()
	{
		...
		else
		{
			...
			if (front == NULL)
				rear = NULL;
			delete temp;
			cout << "\tSuccessfully Removed/DeQueued From the Queue...!\n\n";
		}
	}
...
public:
	...
	void Enqueue()
	{
		...
		cout << "\nSuccessfully InsertedsEnQueued into Queue..!\n\n";
	}
	...
	void Display()
	{
		...
		if (front == NULL)
			...
			temp = front;
			cout << "\t\t*City Record from front to rear*" << endl;
			while (temp != NULL)
			{
				temp->display();
				temp = temp->next;
...
public:
	...
	void Display()
	{
		...
		if (front == NULL)
			...
			temp = front;
			cout << "\t\t*Fly Scheduling Record from front to rear*" << endl;
			while (temp != NULL)
			{
				temp->display();
				temp = temp->next;
	...
	void Dequeue()
	{
		...
		if (front == NULL)
			...
			if (front == NULL)
				rear = NULL;
			delete temp;
			cout << "\tSuccessfully Removed/Dequeueed From the Queue...!\n\n";
		}
	};
	...
	{
		int key;
		FlyScheduling_Node* current = front;
	...
	void Modify()
	{
		...
		while (temp != NULL)
		{
			if (temp->flyScheduling.getflyNo() == key)
			{
				...
				temp->flyScheduling = update_FlyScheduling;
...
public:
	...
	void Display()
	{
		...
		if (front == NULL)
			...
			temp = front;
			cout << "\t\tFlyingbooking Record from front to rear " << endl;
			while (temp != NULL)
			{
				temp->display();
				temp = temp->next;
	...
	{
		int key;
		Flyingbooking_Node* current = front;
