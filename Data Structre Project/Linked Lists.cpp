...
public:
	...
	Passenger(string n, long int id, string con, int r)
	{
		Name = n;
		ID = id;
		contactInfo = con;
...
public:
	...
	FlyingBooking(int f, string r, string pi, int d, string ds, string dn)
	{
		flyNo = f;
		bookingRef = r;
		passengerInfo = pi;
	...
	void setpassengerInfo(string pi)
	{
		passengerInfo = pi;
	}
	...
	void printBookingInfo()
	{
		cout << "Fly Number is :" << getflyNo() << "\n";
		cout << "Booking Refrence Information is: " << getBookingRef() << "\n";
		cout << "Passenger Information is :" << getpassengerInfo() << "\n";
		cout << "Data Time is :" << getdataTime() << "\n";
		cout << "Departing City is :" << getdepartingCity() << "\n";
		cout << "Destination City is :" << getdestinationCity() << "\n";
	}
...
public:
	...
	void Display()
	{
		...
		if (head == NULL)
			...
			while (temp != NULL)
			{
				cout << "\t\tPassenger Record # " << count << endl;
				temp->display();
				temp = temp->next;
				count++;
			}
...
public:
	...
	{
		int key;
		FlyScheduling_Node* current = head;
	...
	void Modify()
	{
		...
		while (temp != NULL)
		{
			if (temp->flyScheduling.getflyNo() == key)
			{
				...
				cout << "Enter FlyScheduling flight number :  ";
				cin >> x_flyNo;
				cout << "Enter FlyScheduling dateTime:  ";
				cin >> x_dateTime;
...
struct Flyingbooking_Node
{
	...
	void display()
	{
		...
		cout << "passenger info : " << flyingBooking.getpassengerInfo() << endl;
		cout << "date time(24h) : " << flyingBooking.getdataTime() << endl;
...
public:
	...
	void Display()
	{
		...
		if (head == NULL)
			...
			while (temp != NULL)
			{
				cout << "\t\tFlyingbooking Record # " << count << endl;
				temp->display();
				temp = temp->next;
				count++;
			}
	...
	{
		int key;
		Flyingbooking_Node* current = head;
